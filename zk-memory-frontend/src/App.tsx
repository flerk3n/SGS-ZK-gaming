...
import { ZkMemoryGame } from './games/zk-memory/ZkMemoryGame';

const GAME_ID = 'zk-memory';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Zk Memory';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_ZK_MEMORY_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
